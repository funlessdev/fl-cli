...
func (_m *UserHandler) List(ctx context.Context) (pkg.UserNamesList, error) {
	...
	var r0 pkg.UserNamesList
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (pkg.UserNamesList, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) pkg.UserNamesList); ok {
		r0 = rf(ctx)
	} else {
		r0 = ret.Get(0).(pkg.UserNamesList)
	}
